...
public class Reactiondata implements Serializable{
		...
		//引数があるコンストラクタ
		public Reactiondata(String user_name, String user_img, String video_name, String star, String review_date, String genre_name, String feelcat_name1, String feelcat_name2, String review_contents, String stamp_name) {
			super();
